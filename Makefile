...
$(BUILD_DIR)/kernel.bin: $(BUILD_DIR)/kernel_entry.o $(KERNEL_OBJS) $(DRIVER_OBJS) $(UTIL_OBJS) $(CPU_OBJS) $(BUILD_DIR)/interrupt.o
...
$(BUILD_DIR)/%.o: $(SRC_DIR)/%.c | $(BUILD_DIR)
	i386-elf-gcc -ffreestanding -I$(SRC_DIR) -I$(DRIVERS_DIR) -I$(UTILS_DIR) -I$(CPU_DIR) -g -c $< -o $@
...
$(BUILD_DIR)/kernel.elf: $(BUILD_DIR)/kernel_entry.o $(KERNEL_OBJS) $(DRIVER_OBJS) $(UTIL_OBJS) $(CPU_OBJS) $(BUILD_DIR)/interrupt.o
